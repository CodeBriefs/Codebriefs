...
import { ClipboardIcon, CheckIcon, DownloadIcon, XIcon, MenuIcon, Code, Contact, Home, User, X} from 'lucide-react'
...
export default function Component() {
  ...
  const topics: Topic[] = [
    { id: 'introduction', title: 'Introduction to Java' },
...
public class ForLoop {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-500">      
      ...
      {/* <div className="inline min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-500">
      ...
      {/* Sidebar */}
      <div className={`inline fixed inset-y-0 left-0 transform ${showSidebar ? 'translate-x-0' : '-translate-x-full'} w-64 bg-white dark:bg-gray-800 overflow-y-auto transition duration-200 ease-in-out z-30 md:relative md:translate-x-0`}>
        <div className="p-6">
